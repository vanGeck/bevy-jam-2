...
pub fn create_grids(
    ...
    commands
        ...
        .with_children(|parent| {
            config.equipped.slots.iter()
                .for_each(|(slot, coords)| {
                    parent.spawn_bundle(SpriteBundle {
                        ...
                        transform: Transform::from_xyz(
                            (coords.pos.x as f32 + coords.dimens.x as f32 * 0.5) - (parent_coords.dimens.x as f32 * 0.5),
                            (coords.pos.y as f32 + coords.dimens.y as f32 * 0.5) - (parent_coords.dimens.y as f32 * 0.5),
