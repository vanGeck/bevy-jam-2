...
fn draw_game_over_screen(mut egui_context: ResMut<EguiContext>, windows: ResMut<Windows>, mut state: ResMut<State<AppState>>, result: Res<State<GameResult>>) {
